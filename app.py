...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Arham43-ops/ResumeIQ' target='_blank' style='text-decoration: none;'>
    ...
    "Portfolio Website", value=existing_portfolio)
        ...
        st.markdown("---")
        st.subheader("Profile Image (Optional)")
        st.write("Upload your professional profile photo to include in your resume")
        ...
        with col1:
            uploaded_image = st.file_uploader(
                ...
                type=['jpg', 'jpeg', 'png'],
                help="Upload a professional headshot. Supported formats: JPG, JPEG, PNG",
            ...
            if uploaded_image is not None:
                ...
                st.session_state.form_data['profile_image'] = {
                    'data': image_base64,
                    'format': uploaded_image.type.split('/')[-1]  # Extract format (jpg, png, etc.)
                }
                
                st.success("✅ Image uploaded successfully!")
            elif 'profile_image' in st.session_state.form_data:
                # Clear image if user removed it
                if st.button("🗑️ Remove Profile Image"):
                    st.session_state.form_data['profile_image'] = None
                    st.rerun()
        
        with col2:
            # Display image preview
            if 'profile_image' in st.session_state.form_data and st.session_state.form_data['profile_image']:
                st.write("**Preview:**")
                try:
                    import base64
                    from io import BytesIO
                    ...
                    # Decode base64 image
                    image_data = base64.b64decode(st.session_state.form_data['profile_image']['data'])
                    image = Image.open(BytesIO(image_data))
                    
                    # Display preview
                    st.image(image, width=150, caption="Your profile photo")
                except Exception as e:
        ...
        if st.button("Generate Resume 📄", type="primary"):
            ...
            try:
                ...
                resume_data = {
                    ...
                    "profile_image": st.session_state.form_data.get('profile_image', None)
                }
